    ...
    <Main className='gap-16 px-4 py-4 md:px-12 md:py-8'>
      ...
      <main className='flex flex-col items-center justify-center gap-12'>
        <Image
          ...
          priority
        />
        <article className='prose-lg mx-auto max-w-[32ch] lg:prose-xl prose-h2:text-[24px] lg:prose-h2:text-[30px]'>
          <h2 className='text-balance leading-tight'>
            America has a rent problem, and we&apos;re here to help fix it.
          </h2>
          <p className='text-balance font-serif text-base leading-snug'>
